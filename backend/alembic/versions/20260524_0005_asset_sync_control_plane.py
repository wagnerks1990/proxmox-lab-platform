...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "asset_id", sa.Integer(), sa.ForeignKey("asset_catalog.id"), nullable=False
        ),
        sa.Column("node_name", sa.String(length=120), nullable=False),
        sa.Column(
            "state", sa.String(length=32), nullable=False, server_default="missing"
        ),
    ...
    op.create_unique_constraint(
        "uq_asset_node_state_asset_node", "asset_node_state", ["asset_id", "node_name"]
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "asset_id", sa.Integer(), sa.ForeignKey("asset_catalog.id"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "job_id", sa.Integer(), sa.ForeignKey("asset_sync_jobs.id"), nullable=False
        ),
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "uq_asset_node_state_asset_node", "asset_node_state", type_="unique"
    )
