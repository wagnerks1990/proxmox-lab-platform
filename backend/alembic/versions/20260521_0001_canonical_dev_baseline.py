...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["template_id"], ["vm_templates.id"], name="fk_permissions_template_id_vm_templates"),
    )
    ...
    op.create_table(
        ...
        sa.Column("proxmox_node", sa.String(length=50), nullable=False),
        sa.Column("status", sa.String(length=20), nullable=True, server_default="provisioning"),
        ...
        sa.Column("ssh_enabled", sa.Boolean(), nullable=True, server_default=sa.text("true")),
        sa.Column("rdp_enabled", sa.Boolean(), nullable=True, server_default=sa.text("false")),
        sa.Column("spice_enabled", sa.Boolean(), nullable=True, server_default=sa.text("false")),
        sa.Column("console_enabled", sa.Boolean(), nullable=True, server_default=sa.text("true")),
        ...
        sa.Column("created_at", sa.DateTime(), nullable=True, server_default=sa.text("now()")),
        sa.ForeignKeyConstraint(["owner_id"], ["users.id"], name="fk_student_vms_owner_id_users"),
        sa.ForeignKeyConstraint(["template_id"], ["vm_templates.id"], name="fk_student_vms_template_id_vm_templates"),
    )
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=True, server_default=sa.text("now()")),
        sa.ForeignKeyConstraint(["actor_id"], ["users.id"], name="fk_connection_launches_actor_id_users"),
        sa.ForeignKeyConstraint(["vm_id"], ["student_vms.id"], name="fk_connection_launches_vm_id_student_vms"),
    )
    ...
    op.create_index("ix_desktop_pools_pool_type", "desktop_pools", ["pool_type"], unique=False)
    op.create_index("ix_desktop_pools_maintenance_mode", "desktop_pools", ["maintenance_mode"], unique=False)
    op.create_index("ix_desktop_pools_enabled", "desktop_pools", ["enabled"], unique=False)
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False, server_default=sa.text("now()")),
        sa.Column("updated_at", sa.DateTime(), nullable=False, server_default=sa.text("now()")),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], name="fk_vm_sessions_user_id_users"),
        sa.ForeignKeyConstraint(["vm_id"], ["student_vms.id"], name="fk_vm_sessions_vm_id_student_vms"),
        sa.ForeignKeyConstraint(["connection_launch_id"], ["connection_launches.id"], name="fk_vm_sessions_connection_launch_id_connection_launches"),
    )
