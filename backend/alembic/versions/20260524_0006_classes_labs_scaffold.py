...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('student_can_reset', sa.Boolean(), nullable=False, server_default=sa.text('false')),
        sa.Column('student_can_power_off', sa.Boolean(), nullable=False, server_default=sa.text('false')),
        sa.Column('terminal_enabled', sa.Boolean(), nullable=False, server_default=sa.text('false')),
        sa.Column('console_enabled', sa.Boolean(), nullable=False, server_default=sa.text('false')),
        sa.Column('rdp_enabled', sa.Boolean(), nullable=False, server_default=sa.text('false')),
        sa.Column('created_at', sa.DateTime(), server_default=sa.func.now(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.func.now(), nullable=False),
        sa.ForeignKeyConstraint(['class_id'], ['classes.id'], ondelete='CASCADE'),
