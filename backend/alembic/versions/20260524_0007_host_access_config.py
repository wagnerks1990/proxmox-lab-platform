...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('runner_user', sa.String(length=120), nullable=False, server_default='proxmox-lab-runner'),
        sa.Column('auth_method', sa.String(length=32), nullable=False, server_default='ssh_key'),
        ...
        sa.Column('status', sa.String(length=32), nullable=False, server_default='api_only'),
        sa.Column('last_checked_at', sa.DateTime(), nullable=True),
        sa.Column('created_at', sa.DateTime(), server_default=sa.func.now(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.func.now(), nullable=False),
        sa.ForeignKeyConstraint(['cluster_id'], ['proxmox_clusters.id'], ondelete='CASCADE'),
        sa.UniqueConstraint('cluster_id', 'node_name', name='uq_host_access_cluster_node'),
    )
