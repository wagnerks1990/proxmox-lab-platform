...
class ProtocolService:
    ...
    def log_launch(self, user: User, vm: StudentVM, protocol: str, status: str = 'success', details: str | None = None):
        self.db.add(ConnectionLaunch(actor_id=user.id, vm_id=vm.id, protocol=protocol, status=status, details=details))
