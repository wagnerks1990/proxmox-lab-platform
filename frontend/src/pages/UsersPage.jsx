...
export default function UsersPage(){
  ...
  return <section>
    ...
    <div className='panel'><h3>{editing?'Edit User':'Create User'}</h3><div className='group'>
      ...
      <select className='input' value={form.role_id} onChange={e=>setForm({...form,role_id:Number(e.target.value)})}><option value='1'>Student</option><option value='2'>Teacher</option><option value='3'>Admin</option></select>
