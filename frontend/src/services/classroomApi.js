...
export const changeLabRunState = (id, action, confirmation = null) => api.patch(`/admin/lab-runs/${id}/state`, { action, confirmation }).then(data)
export const previewLabRunClose = (id, action = 'end') => api.get(`/admin/lab-runs/${id}/close-preview`, { params: { action } }).then(data)
