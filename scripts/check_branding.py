...
# package-lock.json is generated by npm. Its root package metadata must be updated
# by npm regeneration rather than hand-editing through repository automation.
